...
import { ArrowDownUp, CalendarIcon, Repeat } from "lucide-react-native";
import { format } from "date-fns";
import CalendarComponent from "../../../components/inputs/calender";

function RecurringRide({
  recurring,
  setRecurring,
  frequency,
  setFrequency,
  toggleRecurringStartDatePicker,
  recurringStartdate,
  showrecurringStartDatePicker,
  setrecurringStartDate,
  setShowrecurringStartDatePicker,
  endType,
  setEndType,
        ...
        <View>
          ...
          >
            <TouchableOpacity
              ...
              style={[styles.tab, endType === "By Date" && styles.activeTab]}
            >
              <Text
                style={[
                  commonStyling.subtitle,
